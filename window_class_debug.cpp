...
std::string WindowMessageMap::operator()(DWORD msg, LPARAM lp, WPARAM wp) const {
    ...
    oss << "    WP: 0x" << std::hex << std::setfill('0') << std::setw(8) << lp;
    oss << "    LP: 0x" << std::hex << std::setfill('0') << std::setw(8) << wp << std::endl;
    return oss.str();
}
